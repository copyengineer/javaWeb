...
<head>
    ...
    <title>网上书城</title>
    <base href="http://localhost:8080/BookStore5/">
    <link rel="stylesheet" href="Pages/css/index.css">
</head>
<body>
	<%
		//out.print(session.getAttribute("allBookInfo"));
		out.print(request.getAttribute("activepage"));
		//out.print(((Page)(request.getAttribute("page"))).getLastPage());
	%>
	<%!String a = "全部"; %>
    <div class="main">
        <div class="head">
            <div class="head_top">
                ...
                <input type="submit" class="search_btn" value="" onclick="getbook_bykeyword()">
        ...
        <div class="book">
            <c:forEach items="${requestScope.allBookInfo }" var="oneBook" end="1">
            	<div class="one_book">
            ...
            <div class="page_choice" style="float: left;">
            	<a href="" style="display:${requestScope.page.getLastPage()}"><</a>
                <a onclick="change_page(1)" class="page_btn" style="display:${requestScope.page.getPagechoice1().keySet().contains("inline-block")?"inline-block":"none"};background:${requestScope.activepage==1?"red":"" }">${requestScope.page.getPagechoice1().keySet().contains("inline-block")?requestScope.page.getPagechoice1().get("inline-block"):""}</a>
                <em style="display:${requestScope.page.getOmit1()}">...</em>
                <a onclick="change_page(2)" class="page_btn" style="display:${requestScope.page.getPagechoice2().keySet().contains("inline-block")?"inline-block":"none"}">${requestScope.page.getPagechoice2().keySet().contains("inline-block")?requestScope.page.getPagechoice2().get("inline-block"):""}</a>
                <a onclick="change_page(3)" class="page_btn" style="display:${requestScope.page.getPagechoice3().keySet().contains("inline-block")?"inline-block":"none"}">${requestScope.page.getPagechoice3().keySet().contains("inline-block")?requestScope.page.getPagechoice3().get("inline-block"):""}</a>
                <a onclick="change_page(4)" class="page_btn" style="display:${requestScope.page.getPagechoice4().keySet().contains("inline-block")?"inline-block":"none"}">${requestScope.page.getPagechoice4().keySet().contains("inline-block")?requestScope.page.getPagechoice4().get("inline-block"):""}</a>
                <a onclick="change_page(5)" class="page_btn" style="display:${requestScope.page.getPagechoice5().keySet().contains("inline-block")?"inline-block":"none"}">${requestScope.page.getPagechoice5().keySet().contains("inline-block")?requestScope.page.getPagechoice5().get("inline-block"):""}</a>
                <a onclick="change_page(6)" class="page_btn" style="display:${requestScope.page.getPagechoice6().keySet().contains("inline-block")?"inline-block":"none"}">${requestScope.page.getPagechoice6().keySet().contains("inline-block")?requestScope.page.getPagechoice6().get("inline-block"):""}</a>
                <em style="display:${requestScope.page.getOmit2()}">...</em>
                <a onclick="change_page(7)" class="page_btn" style="display:${requestScope.page.getPagechoice7().keySet().contains("inline-block")?"inline-block":"none"}">${requestScope.page.getPagechoice7().keySet().contains("inline-block")?requestScope.page.getPagechoice7().get("inline-block"):""}</a>
                <em style="display:${requestScope.page.getOmit3()}">...</em>
                <a onclick="change_page(8)" class="page_btn">${requestScope.page.getPagechoice8().keySet().contains("inline-block")?requestScope.page.getPagechoice8().get("inline-block"):""}</a>
                <a>></a>
                跳转到：
    ...
    <script type="text/javascript" src="Pages/js/index.js?ver=1"></script>
</body>
</html>